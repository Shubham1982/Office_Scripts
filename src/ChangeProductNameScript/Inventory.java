package ChangeProductNameScript;//Product-service Inventory Table
...
public class Inventory {
    ...
    public static String generateQuery(String id, String product_name) {
        ...
        return "update product_inventory pi join product p on pi.product_code = p.product_code and pi.enterprise_id = p.enterprise_id set  pi.measurement_unit='"+product_name+"', pi.last_modified_by = 'backend_s', pi.last_modified_date = now()\n" +
